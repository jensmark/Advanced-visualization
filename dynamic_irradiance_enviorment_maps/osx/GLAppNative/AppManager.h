...
private:
    ...
    /**
     * Generates paraboloid enviorment maps
     */
    void renderParaboloidEnvMap();
    
    /**
     * projects paraboloid texture to spherical harmonics coef
     */
    void projectParaboloidToSH();
    
    /**
     * Envaluated convolved spherical harmonics
     */
    void evaluateConvolvedSH();
